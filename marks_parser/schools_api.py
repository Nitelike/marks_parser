...
def parse(login, password, pupil_id):
	...
	school_url = parent_url[:parent_url.find('/parent/')]
	...
	if mode == 1:
		...
		month2 = 10
		day = 1
		day2 = days_in_month(month2, year2)
	elif mode == 2:
		year = now.year
		year2 = year
		month = 11
		...
		day2 = days_in_month(month2 - 12, year2)
	elif mode == 7:
		year = now.year
		year2 = year
		month = 3
...
def getChildren(login, password):
	session_requests = requests.session()
